...
columns = "24" >
    < image
source = "../../Art/Water and Sand/Tileset_Water.png"
width = "384"
height = "192" / >
    < tile
id = "0" >
...
y = "1.0625" >
    < polygon
points = "0,0 -1,1 -1.875,2.9375 -1.9375,11.9375 -1,13.9375 0,14.9375 10.1875,14.875 11.0625,13.0625 11.1875,4.875 12,3.9375 12.125,2.875 11.25,0.8125 10.0625,-0.125" / >
    < /object>
</objectgroup>
<animation>
...
<tile id="1">
    <objectgroup draworder="index" id="2">
        <object id="1" x="2.875" y="15.9375">
            <polygon
                points="0,0 -0.9375,-1 -1.9375,-2.9375 -1.8125,-13.875 -0.875,-15.0625 10.0625,-15.0625 12,-14.1875 13.125,-13.0625 13.125,0.0625"/>
        </object>
    </objectgroup>
    <animation>
...
<tile id="2">
    <objectgroup draworder="index" id="2">
        <object id="1" x="-0.0625" y="2.9375">
            <polygon
                points="0,0 2.125,-2.0625 4.125,-2 5.9375,-0.9375 8.0625,-1.0625 10,-2.0625 13.0625,-2.125 14.875,-1.0625 16,-0.0625 16.0625,13.0625 0.0625,13.0625"/>
        </object>
    </objectgroup>
    <animation>
...
<tile id="3">
    <objectgroup draworder="index" id="2">
        <object id="1" x="0.0625" y="3">
            <polygon
                points="0,0 0.75,-0.875 2.875,-2 13.8125,-2.1875 14.875,-1.0625 14.9375,10 13.9375,12.0625 13.0625,12.875 -0.0625,13"/>
        </object>
    </objectgroup>
    <animation>
...
<tile id="4">
    <objectgroup draworder="index" id="2">
        <object id="1" x="-0.0625" y="3">
            <polygon
                points="0,0 2.0625,-2.125 4,-2.125 6.0625,-1.0625 7.9375,-1 10,-2 13.0625,-2.0625 15,-1.0625 16,-0.0625 16.0625,13 3,13.0625 1.9375,11.8125 0.0625,12"/>
        </object>
    </objectgroup>
    <animation>
...
<tile id="24">
    <objectgroup draworder="index" id="2">
        <object id="1" x="2.9375" y="-0.0625">
            <polygon
                points="0,0 -1.0625,2.0625 -1.9375,5.0625 -2,6.9375 -1.0625,10.0625 -1,15.875 10.0625,16.0625 11,15 12.125,12.0625 12.1875,10.0625 11.0625,7.125 11,0"/>
        </object>
    </objectgroup>
    <animation>
...
<tile id="29">
    <objectgroup draworder="index" id="2">
        <object id="1" x="14.0625" y="0">
            <polygon
                points="0,0 0.8125,0.875 1.875,1.9375 2,13.9375 -0.0625,15.0625 -10.125,14.9375 -14.0625,14 -14.0625,0"/>
        </object>
    </objectgroup>
    <animation>
...
<tile id="48">
    <objectgroup draworder="index" id="2">
        <object id="1" x="2" y="-0.0625">
            <polygon
                points="0,0 -0.0625,9.9375 0.875,12 2.875,13.9375 3.875,14.9375 7.875,15.0625 9,14 10.75,13.125 12.875,11.1875 13.0625,4.0625 12.0625,2.1875 11,0.0625"/>
        </object>
    </objectgroup>
    <animation>
...
<tile id="49">
    <objectgroup draworder="index" id="2">
        <object id="1" x="1.875" y="-0.0625">
            <polygon
                points="0,0 -0.0625,9.8125 0.9375,11.9375 3.9375,15.0625 12.125,15.0625 14.125,13.9375 14.125,0.0625"/>
        </object>
    </objectgroup>
    <animation>
...
<tile id="51">
    <objectgroup draworder="index" id="2">
        <object id="1" x="0.0625" y="13.9375">
            <polygon
                points="0,0 1.8125,1.0625 9.875,1.125 12.9375,-1.875 13.8125,-3.9375 13.875,-13.875 -0.0625,-13.9375"/>
        </object>
    </objectgroup>
    <animation>
...
<tile id="52">
    <objectgroup draworder="index" id="2">
        <object id="1" x="2.9375" y="0">
            <polygon
                points="0,0 -0.9375,1.875 -2.0625,5.0625 -2.0625,6.9375 -0.9375,9.8125 -0.9375,16 13.0625,16 13.0625,1.875 11.125,0"/>
        </object>
    </objectgroup>
    <animation>
...
<tile id="53">
    <objectgroup draworder="index" id="2">
        <object id="1" x="-0.125" y="3">
            <polygon
                points="0,0 2.0625,-2.0625 4,-2.0625 6,-1.0625 8,-1 10.0625,-2 13,-2 15,-1 16.0625,-0.0625 16.1875,12 14.1875,13 0.125,13"/>
        </object>
    </objectgroup>
    <animation>
...
<tile id="73">
    <objectgroup draworder="index" id="2">
        <object id="1" x="16" y="3">
            <polygon
                points="0,0 -1.0625,-1 -2.9375,-2.0625 -14.0625,-1.9375 -15,-0.9375 -15.0625,3.75 -14.125,6.875 -13.0625,9 -10.1875,11.875 -2.125,12.0625 0.0625,10.9375"/>
        </object>
    </objectgroup>
    <animation>
...
<tile id="74">
    <objectgroup draworder="index" id="2">
        <object id="1" x="0" y="3">
            <polygon
                points="0,0 1.9375,-2.0625 3.9375,-2 6.0625,-1 7.875,-1.0625 9.9375,-1.9375 12.9375,-1.9375 14.75,-1.0625 15.9375,0 15.9375,10.9375 13.9375,12 3.8125,12.125 0.0625,10.9375"/>
        </object>
    </objectgroup>
    <animation>
...
<tile id="75">
    <objectgroup draworder="index" id="2">
        <object id="1" x="0.125" y="3.0625">
            <polygon
                points="0,0 0.8125,-1 2.8125,-2.125 13.75,-2.125 14.875,-1.1875 14.8125,4 13.8125,6.9375 12.875,9 9.75,11.9375 1.6875,11.875 -0.1875,11.0625"/>
        </object>
    </objectgroup>
    <animation>
...
<tile id="76">
    <objectgroup draworder="index" id="2">
        <object id="1" x="16" y="0">
            <polygon
                points="0,0 0,14.0625 -2.0625,15 -12.0625,15.0625 -16,14.0625 -16,1.9375 -14.0625,0.875 -12.9375,0"/>
        </object>
    </objectgroup>
    <animation>
...
<tile id="77">
    <objectgroup draworder="index" id="2">
        <object id="1" x="13.0625" y="0">
            <polygon
                points="0,0 0.8125,2 1.9375,4.9375 2,7 1,9.8125 1.0625,16 -10.0625,15.9375 -11.125,14.875 -13.125,15.0625 -13.0625,0"/>
        </object>
    </objectgroup>
    <animation>
...
<tile id="98">
    <objectgroup draworder="index" id="2">
        <object id="1" x="15.9375" y="15.0625">
            <polygon
                points="0,0 -1.875,0.9375 -12.875,0.875 -14,-0.125 -14.9375,-2.125 -15.0625,-13 -13.875,-14.0625 -3.0625,-14 -1.0625,-13.0625 0.0625,-12.0625"/>
        </object>
    </objectgroup>
    <animation>
...
<tile id="99">
    <objectgroup draworder="index" id="2">
        <object id="1" x="0" y="3">
            <polygon
                points="0,0 0.875,-1 2.875,-1.9375 13.875,-2 15.125,-1.125 15,9.875 14,11.9375 13,13 3,13.0625 1.9375,11.875 0.0625,11.9375"/>
        </object>
    </objectgroup>
    <animation>
...
<tile id="122">
    <objectgroup draworder="index" id="2">
        <object id="1" x="14.0625" y="0.125">
            <polygon
                points="0,0 1.875,1.875 1.9375,13.875 -0.0625,14.9375 -8.125,14.875 -11,11.875 -12.125,9.9375 -12,-0.0625"/>
        </object>
    </objectgroup>
    <animation>
...
<tile id="123">
    <objectgroup draworder="index" id="2">
        <object id="1" x="-0.125" y="2.0625">
            <polygon
                points="0,0 2,-0.9375 3,-1.9375 14.125,-2 14.125,7.75 13.0625,9.9375 10.125,12.9375 2,13 0,11.875"/>
        </object>
    </objectgroup>
    <animation>
...
<tile id="144">
    <objectgroup draworder="index" id="2">
        <object id="1" x="0" y="2.0625">
            <polygon
                points="0,0 1.875,-1 3,-2.125 14.0625,-2.125 16,-0.25 16,13.9375 2.9375,13.875 1.875,12.9375 0.0625,12.875"/>
        </object>
    </objectgroup>
    <animation>
...
<tile id="145">
    <objectgroup draworder="index" id="2">
        <object id="1" x="-0.0625" y="2.0625">
            <polygon
                points="0,0 1.9375,-1.125 3.0625,-2.1875 14,-2.125 16,-0.0625 16,12.875 14.0625,14 0.0625,13.9375"/>
        </object>
    </objectgroup>
    <animation>
...
<tile id="146">
    <objectgroup draworder="index" id="2">
        <object id="1" x="3" y="0.0625">
            <polygon
                points="0,0 -1,1.0625 -2.9375,2 -2.9375,13.875 0.75,14.8125 11.125,14.875 12.9375,14 13,1.8125 11,-0.0625"/>
        </object>
    </objectgroup>
    <animation>
...
<tile id="147">
    <objectgroup draworder="index" id="2">
        <object id="1" x="2.9375" y="-0.0625">
            <polygon
                points="0,0 -0.9375,1.9375 -1.9375,5.125 -2,6.8125 -1,10 -0.9375,15.9375 11.1875,16 13,15.125 13,1.9375 11.125,0"/>
        </object>
    </objectgroup>
    <animation>
...
<tile id="168">
    <objectgroup draworder="index" id="2">
        <object id="1" x="-0.0625" y="2">
            <polygon
                points="0,0 2.0625,-1 3,-2 16.0625,-2 16.0625,12.9375 14.125,14.0625 3,13.9375 2.0625,12.9375 0.0625,13"/>
        </object>
    </objectgroup>
    <animation>
...
<tile id="170">
    <objectgroup draworder="index" id="2">
        <object id="1" x="0" y="2">
            <polygon
                points="0,0 1.9375,-1 3,-2.0625 13,-2 14,0.0625 15,3.0625 14.9375,5 14,7.875 13.9375,9.9375 15.9375,10.9375 16,12.875 14.125,13.9375 3.0625,14.125 2.0625,13.125 0,12.9375"/>
        </object>
    </objectgroup>
    <animation>
...
<tile id="171">
    <objectgroup draworder="index" id="2">
        <object id="1" x="0" y="15.125">
            <polygon
                points="0,0 1.9375,-0.125 2.8125,0.8125 14,0.875 16.0625,-0.1875 16,-12.3125 15.0625,-13.125 13,-14.25 10,-14.1875 7.9375,-13.125 6.0625,-13.1875 4.0625,-14.125 2,-14.125 0,-12.1875"/>
        </object>
    </objectgroup>
    <animation>
...
<tile id="172">
    <objectgroup draworder="index" id="2">
        <object id="1" x="-0.0625" y="1.875">
            <polygon
                points="0,0 1.9375,-0.875 3,-1.8125 14,-1.75 16,-0.0625 16.0625,13.125 14,14.1875 2.8125,14.25 1.9375,13 0.0625,13.0625"/>
        </object>
    </objectgroup>
    <animation>
...
<tile id="241" probability="0.3">
    <objectgroup draworder="index" id="2">
        <object id="1" x="-0.1875" y="3">
            <polygon
                points="0,0 2.25,-1.9375 4.0625,-2 6.1875,-1.0625 8.3125,0.8125 10.0625,0.875 11.125,0 13.125,-1 15.125,-1.0625 16.1875,-0.125 16.1875,13 0.1875,13"/>
        </object>
    </objectgroup>
    <animation>
...
<tile id="244" probability="0.3">
    <objectgroup draworder="index" id="2">
        <object id="1" x="16" y="0">
            <polygon
                points="0,0 0,16 -13.1875,16 -13.125,15.125 -12.125,14.0625 -11,12 -10.0625,10.875 -10,8 -11.0625,6.9375 -12.1875,6.0625 -13.125,2.875 -13.125,-0.0625"/>
        </object>
    </objectgroup>
    <animation>
...
<tile id="264" probability="0.3">
    <objectgroup draworder="index" id="2">
        <object id="1" x="13.0625" y="0">
            <polygon
                points="0,0 -0.125,2.8125 -1.0625,5.875 -3,7.875 -3.0625,10.9375 -2.1875,11.875 -1.1875,13.75 -0.0625,14.9375 -0.0625,15.9375 -13.0625,16 -13.0625,0"/>
        </object>
    </objectgroup>
    <animation>
...
<tile id="267" probability="0.3">
    <objectgroup draworder="index" id="2">
        <object id="1" x="0" y="16">
            <polygon
                points="0,0 16,0 16.0625,-13.125 14,-14 12.9375,-15.125 10.875,-15.0625 9,-13.125 7.0625,-11.9375 3.0625,-12 2.0625,-13.125 0.0625,-13.0625"/>
        </object>
    </objectgroup>
    <animation>
...
<tile id="268" probability="0.3">
    <objectgroup draworder="index" id="2">
        <object id="1" x="0" y="0">
            <polygon
                points="0,0 0,16 14.0625,15.9375 14.9375,11.875 16,9.875 16,6.9375 15.0625,5 14.0625,2 13.125,0.0625"/>
        </object>
    </objectgroup>
    <animation>
